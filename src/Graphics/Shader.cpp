...
{
	TestShader.CreateShader("Shaders/Vertex/test.vert", Vertex);
	TestShader.CreateShader("Shaders/Fragment/test.frag", Fragment);
	...
	TextShader.CreateShader("Shaders/Vertex/text.vert", Vertex);
	TextShader.CreateShader("Shaders/Fragment/text.frag", Fragment);
}
